    ...
    <div className="container">
      <div className="baner-card">
        ...
        <div className="row">
          ...
          <div className="mx-auto col-sm-10 mx-md-0 col-md-6 col-lg-4 col-xl-3 bs-col">
            <div className="bs-card card">
              <h5 className="fwb"><NumberFormat thousandSeparator displayType={"text"} value={(+networkDetails?.totalStakeFormatted || 0).toFixed(8)} /> BONE
              </h5>
          ...
          <div className="mx-auto col-sm-10 mx-md-0 col-md-6 col-lg-4 col-xl-3 bs-col">
            <div className="bs-card card">
              <h5 className="fwb"><NumberFormat thousandSeparator displayType={"text"}
          ...
          <div className="mx-auto col-sm-10 mx-md-0 col-md-6 col-lg-4 col-xl-3 bs-col">
            <div className="bs-card card">
              <h5 className="fwb"><NumberFormat thousandSeparator displayType={"text"} value={latestBlock} /></h5>
              <div className="card-hr"></div>
          ...
          <div className="mx-auto col-sm-10 mx-md-0 col-md-6 col-lg-4 col-xl-3 bs-col">
            <div className="bs-card card">
              <h5 className="fwb"><NumberFormat thousandSeparator displayType={"text"} value={networkDetails?.heimdallHeight} /> </h5>
              <div className="card-hr"></div>
          ...
          <div className="mx-auto col-sm-10 mx-md-0 col-md-6 col-lg-4 col-xl-3 bs-col">
            <div className="bs-card card">
              <h5 className="fwb d-flex align-items-center">
                <span>
