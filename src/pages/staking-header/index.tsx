    ...
    <>
            ...
            <div className="pop-top">
              <div className="dark-bg-800 h-100 status-sec sec-ht position-relative status-sep-popup">
                <img
                  ...
                  alt="Wait"
                />
                <p className="light-text primary-text">
                  {" "}
                  Wait for{" "}
                  <NumberFormat
                    style={{ fontSize: "24px" }}
      ...
      <div className="staking_header_wrapper">
        <div className="staking-header dark-bg-800">
          <button
            className="toggle_staking_header"
            onClick={() => showStakingHeader(!stakingHeader)}
          >
            <svg
        ...
        {userType === "Validator" &&
          ...
          validatorInfo?.signer === account && (
            <div className="signer_warning">
              Please switch to your staker account to enable transactions.
            </div>
          )}
      </div>
    </>
