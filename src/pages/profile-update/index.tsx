...
import {
  getValidatorInfo,
  updateValidator,
} from "app/services/apis/network-details/networkOverview";
...
export default function ProfileUpdate() {
  ...
  let schema = yup.object().shape({
    validatorname: yup
      ...
      .max(14, "Name must be less than 15 characters.")
      .typeError("Name must be less than 15 characters.")
      .required("Validator name is required.")
      .matches(/^[a-z\d\-_\s]+$/i, "Entered wrong charactor."),
                ...
                <form onSubmit={handleSubmit}>
                  <div className="progress-tab">
                    <div className="mb-4 mb-xl-5">
                      <h5 className="mb-2 fwb fw-700 ff-mos">
                        Update node details
                      </h5>
                      <p className="ff-mos">
                        You can update/edit your node details for better
                        recognizability
                      </p>
                    </div>
                    <div className="row">
                      <div className="col-sm-6 form-grid">
                        <div className="form-group">
                          <label className="form-label ff-mos">
                            Validator logo
                          </label>
