...
const ChainWarning: React.FC<Props> = ({
  show,
  setshow,
  title,
  externalCls,
  ...
  const switchNetwork = async () => {
    console.debug(`Switching to chain ${GOERLI_CHAIN_ID}`, GOERLI_CHAIN_ID);
    // toggleNetworkModal()
          ...
          <div className="pop-block">
            <div className="pop-top">
              <div className="dark-bg-800 h-100 status-sec sec-ht position-relative text-center">
                <img
                  src="../../assets/images/shib-switch.png"
                  className="m-auto mb-5"
                  style={{ width: 400 }}
                />
                {/* <h3 className="ff-mos small_warning_heading">Approve your network change in Metamask</h3> */}
                <p className="small_warning_text ff-mos mt-4">
                  To use Shibarium Staking change your Metamask network to
                  Ethereum Mainnet.
                </p>
              </div>
            </div>
