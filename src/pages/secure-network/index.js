                ...
                <div className="py-xxl-5 py-sm-4 py-4 ffms-inherit">
                    <section className="container mb-xxl-5 mb-xl-4 mb-sm-3 mb-3">
                        <div className="d-inline-block me-2">
                            <img className="img-fluid" src="../../assets/images/dummy-banner-4.png" alt="check-icon"/>
                        </div>
                        <br/>
                        <br/>
                        ...
                        looked up one of the more obscure Latin words, consectetur </p>
                            ...
                            <div className="col-md-6 col-sm-6 col-xs-12">
                                <div className="image-section  static_img">
                                    <div><img className="img-fluid" src="../../assets/images/500x500-4.png" alt="check-icon"/></div>
                                </div>
                            </div>
                        </div>
                        <br/>
                    ...
                    <section className="container mb-xxl-5 mb-xl-4 mb-sm-3 mb-3">
                        <div className="row">
                            <div className="col-md-7 col-sm-7 col-xs-12">
                                <div className="image-section  static_img">
                                    <div><img className="img-fluid" src="../../assets/images/700x300-4.png" alt="check-icon"/></div>
                                </div>
                            </div>
