        ...
        <main className='delegatorgrid-sec'>
              ...
              <div className='container'>
                <div className='row'>
                  <div className='col-sm-8 text-sm-start text-center'>
                    <h1 className='light-text fnt-58 fnt-100'>My Account As A Validator</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='container'>
            <div className='center-sec text-center'>
              ...
              <h1 className='fw-700 light-text'>10 BONE</h1>
          ...
          <Modal className='shib-popup'
            ...
            <Modal.Body>
              <form action="" className="modal-form">
                ...
                <div className='form-group'>
                  <label htmlFor="" className="form-label">Stakereward</label>
                  <input type="text" className="form-control form-bg" placeholder='Enter stakereward' />
                </div>
