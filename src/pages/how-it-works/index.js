            ...
            <Header />
                <div className="py-xxl-5 py-sm-4 py-4">
                    <section className="container mb-xxl-5 mb-xl-4 mb-sm-3 mb-3">
                        ...
                        <p className="mb-xxl-4 mb-xl-3 mb-sm-2 mb-2">What follows is a set of instructions to deposit and withdraw funds using Shibarium's network. For performing those actions, you need to connect a wallet to Shibarium's environmnet.
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <span className="fw-700">NOTE</span>
                        </div>
                    ...
                    <section className="container mb-xxl-5 mb-xl-4 mb-sm-3 mb-3">
                        ...
                        To log into the testnet version of Shibarium Wallet Suite, you need to access the following URL: <a className="underline" href="javascript:void(0);">https://wallet-dev.Shibarium.technology/.</a></p>
                        <p className="mb-xxl-4 mb-xl-3 mb-sm-2 mb-2">Once you connect your account with the Web Wallet, you will be taken to 
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <span className="fw-700">METAMASK</span>
                        </div>
                        <p className="mt-2">Be attentive to all Metamask's popups.
