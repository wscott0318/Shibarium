                                    ...
                                    <ul className='swp-icon'>
                                        <li>
                                            <a href="/" onClick={() => setSlippageModal(true)}>
                                                <img className='img-fluid' src="../../assets/images/setting.png" alt="icon-img" width={25} height="25" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/">
                                                <img className='img-fluid' src="../../assets/images/faq.png" alt="icon-img" width={25} height="25" />
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div className="form-group">
                                                <div className="form-field position-relative dark-input"  onClick={() => {
                                                  ...
                                                  setToken2State({
                                                    ...
                                                    <div className="coin-icon">
                                                        <div className='coin-img'>
                                                            <img className="img-fluid" src="../../assets/images/shiba-round-icon.png" alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="coin-name">
                        ...
                        <div className="pop-top">
                            <div className="cnfrm_box dark-bg-800">
                                <div className="top_overview col-12">
                                    <div className='img-flexible'><img className="img-fluid d-inline-block" src="../../assets/images/shib-borderd-icon.png" alt="" /></div>
                                    <h6>1000 SHIB</h6>
                                    <p>2000.00$</p>
                                </div>
                            </div>
                ...
                {showSwapModal && swapState.step2 && <div className="popmodal-body tokn-popup no-ht trans-mod">
                  <div className="pop-block">
                    <div className="pop-top">
                        <div className='dark-bg-800 h-100 status-sec'>
                            <span>
                                <div><img width="272" height="272" className="img-fluid" src="../../assets/images/Ellipse.png" alt="" /></div>
                            </span>
