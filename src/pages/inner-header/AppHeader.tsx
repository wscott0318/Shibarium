      ...
      <Dropdown className="nav-item d-flex align-items-center cus-dd app-drop">
        ...
        <NavDropdown className="light-text dd-ico" title={title} id="">
          <NavDropdown.Item href={account ? "/wallet" : "/login"}>
            <h6 className={title === 'Wallet' ? "fw-600 light-text left-border primary-text" : "fw-600 light-text left-border"}>
              Wallet
            </h6>
          ...
          <NavDropdown.Item href={account ? "/bridge" : "/login"}>
            <h6 className={title === 'Bridge' ? "fw-600 light-text left-border primary-text" : "fw-600 light-text left-border"}>
              Bridge
            </h6>
            <span className="light-text">
          ...
          <NavDropdown.Item href="/bone-staking">
            <h6 className={title === 'Staking' ? "fw-600 light-text left-border primary-text" : "fw-600 light-text left-border"}>
              Staking
            </h6>
            <span className="light-text">
