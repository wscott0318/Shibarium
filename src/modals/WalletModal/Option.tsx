  ...
  const content = (
    <div
      ...
      className={classNames(
        ...
        'bg-[rgba(0,0,0,0.2)] focus:outline-none user_Wallet flex items-center gap-4 justify-between w-full px-4 py-3 rounded border border-dark-700 hover:border-blue'
      )}
    >
