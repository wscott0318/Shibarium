  ...
  describe("updateVersion", () => {
    describe("never initialized", () => {
      beforeEach(() => {
        store = createStore(reducer, {
          byUrl: {
            "https://unpkg.com/@uniswap/default-token-list@11.2.0/build/uniswap-default.tokenlist.json":
              {
                error: null,
                current: STUB_TOKEN_LIST,
                loadingRequestId: null,
            ...
            "https://unpkg.com/@sushiswap/default-token-list@41.5.0/build/sushiswap-default.tokenlist.json":
              {
                error: null,
                current: STUB_TOKEN_LIST,
                loadingRequestId: null,
