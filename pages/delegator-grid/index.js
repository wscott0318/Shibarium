            ...
            <div className='blue-bg position-relative sec-spc-high'>
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className=''><button type="button" className='btn warning-btn border-btn light-text'><span>Become A Validator</span></button></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className='box'>
                            <div className='box-head'>
                                <div className='d-flex align-items-center justify-content-start'>
                                    ...
                                    <div className='fw-700'>
                                        ...
                                        <p><span className='ft-16 grey-color'>13,861 SHIBA Staked</span></p>
                                    </div>
                                </div>
                            </div>
                            <div className='box-body'>
                                ...
                                <div className='text-center mt-3'>
                                    <button type="button" onClick={() => setModalShow(true)} className='btn warning-btn border-btn light-text w-100'><span>Delegate</span></button> 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='col-xl-3 col-sm-6 col-12 side-space'>
                        <div className='box'>
                            ...
                            <div className='box-body'>
                                ...
                                <div className='text-center mt-3'>
                                    <button type="button" className='btn warning-btn border-btn light-text w-100'><span>Delegate</span></button> 
                                </div>
                            </div>
                        </div>
                    </div>
