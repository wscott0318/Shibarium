      ...
      <div className="page-wrapper">
        ...
        <aside className='sidebar'>
          <a href="javascript:void(0)" class="close-icon">
            <img class="img-fluid" src="../../assets/images/download.svg" alt="" />
          </a>
          <div class="side-logo">
            <a href="./home">
          ...
          <div className='pt-4 botom-spacing'>
            <div className='row'>
              <div className='col-sm-12 col-md-6'>
                ...
                <div className='border-orange card-box'>
                  ...
                  <div className='btn-sec'>
                    <button type="button" class="btn button-light lightborder uppercase-txt"><span>Initiate burn</span></button>
                  </div>
              ...
              <div className='col-sm-12 col-md-6 '>
                ...
                <div className='border-orange card-box'>
                  ...
                  <div className='btn-sec'>
                    <button type="button" class="btn warning-btn border-btn light-text uppercase-txt"><span>Complete burn</span></button>
                  </div>
                </div>
              </div>
            </div>
